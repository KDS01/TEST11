...
<head>
    ...
    <style>
        ...
        body{
            background-image:url('/Deep_sleep/deep_sleep/images/stage1-2BackGround.jpg');
...
<body style="background-color:  black;">
    ...
    <div class="clawHammer" onclick=""></div>
    <form action="/Deep_sleep/deep_sleep/stage2/index.jsp">
